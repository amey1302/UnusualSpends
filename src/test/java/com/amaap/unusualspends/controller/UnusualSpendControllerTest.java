...
public class UnusualSpendControllerTest {

    CustomerService customerService;
    CreditCardService creditCardService;
    TransactionService transactionService;
    UnusualSpendController unusualSpendController;
    ...
    void setUp() {
        ...
        unusualSpendController = injector.getInstance(UnusualSpendController.class);
    ...
    void shouldBeAbleToFindUnusualSpend() throws InvalidCreditCardIdException, InvalidTransactionDataException, CreditCardNotFoundException {
        ...
        Map<Integer, List<SpendRecordDto>> actual = unusualSpendController.evaluateSpend(currentMonthTransactions, previousMonthTransactions, thresholdPercentage);
    ...
    void shouldBeAbleToGetOkResponseWhenEmailSendToCustomer() throws InvalidCreditCardIdException, InvalidTransactionDataException, CreditCardNotFoundException, InvalidCustomerDataException, CustomerNotFoundException {
        ...
        Response actual = unusualSpendController.sendEmail(spendRecord);
