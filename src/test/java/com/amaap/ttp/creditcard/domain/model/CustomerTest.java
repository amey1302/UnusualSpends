...
class CustomerTest {
    ...
    void shouldAbleToThrowExceptionWhenCustomerNameIsInvalid() {
        ...
        assertThrows(InvalidCustomerNameException.class, () -> {
            Customer.create(1, "9786789089", "baburao@babu.com");
        });
    }
    ...
    void shouldAbleToThrowAnExceptionWhenCustomerEmailIdIsInvalid() {
        ...
        assertDoesNotThrow(() -> {
            Customer.create(1, "Baburao Apte", "baburao@example.com");
        });
        assertDoesNotThrow(() -> {
            Customer.create(1, "Baburao Apte", "baburao_apte123@example.com");
        });
        assertDoesNotThrow(() -> {
            Customer.create(1, "Baburao Apte", "baburao.apte123@example.co.uk");
        });
        ...
        assertThrows(InvalidCustomerEmailIdException.class, () -> {
            Customer.create(1, "Baburao Apte", "@example.com");
        });
        assertThrows(InvalidCustomerEmailIdException.class, () -> {
            Customer.create(1, "Baburao Apte", "baburao@babu@com");
        });
        assertThrows(InvalidCustomerEmailIdException.class, () -> {
            Customer.create(1, "Baburao Apte", "baburao.apte@example");
        });
        assertThrows(InvalidCustomerEmailIdException.class, () -> {
            Customer.create(1, "Baburao Apte", "Baburao.apte     @.gmail.com");
        });
        assertThrows(InvalidCustomerEmailIdException.class, () -> {
            Customer.create(1, "Baburao Apte", "baburao.babu0@com...com.");
        });
        assertThrows(InvalidCustomerEmailIdException.class, () -> {
